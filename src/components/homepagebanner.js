...
export default function Example() {
  return (
    <div className="relative">
      ...
      <div className="relative max-w-6xl mx-auto py-24 px-4 sm:py-16 sm:px-6 lg:px-8">
        <div className='sm:px-0 lg:px-8'>
            <p className="text-lg  text-white sm:text-6xl lg:text-6xl">CUSTOM</p>
            <p className="text-lg  text-white sm:text-6xl lg:text-6xl"><b>POKER</b> CHIPS</p>
